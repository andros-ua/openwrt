...
define Device/comfast_cf-wr630ax-common
  DEVICE_VENDOR := COMFAST
...
define Device/comfast_cf-wr630ax
  DEVICE_DTS := mt7981b-comfast-cf-wr630ax
  IMAGE_SIZE := 65536k
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
  SUPPORTED_DEVICES += cf-wr630ax
  $(call Device/comfast_cf-wr630ax-common)
endef
TARGET_DEVICES += comfast_cf-wr630ax

define Device/comfast_cf-wr630ax-ubi
  DEVICE_VARIANT := (UBI)
  DEVICE_DTS := mt7981b-comfast-cf-wr630ax-ubi
  UBOOTENV_IN_UBI := 1
  IMAGES := sysupgrade.itb
  KERNEL_INITRAMFS_SUFFIX := -recovery.itb
  KERNEL := kernel-bin | gzip
  ...
  ARTIFACT/bl31-uboot.fip := mt7981-bl31-uboot comfast_cf-wr630ax-ubi
  $(call Device/comfast_cf-wr630ax-common)
endef
TARGET_DEVICES += comfast_cf-wr630ax-ubi
...
define Device/comfast_cf-wr633ax
  ...
  IMAGE_SIZE := 65536k
  IMAGE/sysupgrade.bin := sysupgrade-tar | append-metadata
  SUPPORTED_DEVICES += cf-wr633ax
  $(call Device/comfast_cf-wr633ax-common)
endef
TARGET_DEVICES += comfast_cf-wr633ax

define Device/comfast_cf-wr633ax-ubi
  DEVICE_VARIANT := (UBI)
  DEVICE_DTS := mt7981a-comfast-cf-wr633ax-ubi
  UBOOTENV_IN_UBI := 1
  IMAGES := sysupgrade.itb
  KERNEL_INITRAMFS_SUFFIX := -recovery.itb
  KERNEL := kernel-bin | gzip
  ...
  ARTIFACTS := preloader.bin bl31-uboot.fip
  ARTIFACT/preloader.bin := mt7981-bl2 spim-nand-ubi-ddr3-1866
  ARTIFACT/bl31-uboot.fip := mt7981-bl31-uboot comfast_cf-wr633ax-ubi
  $(call Device/comfast_cf-wr633ax-common)
endef
TARGET_DEVICES += comfast_cf-wr633ax-ubi
